...
# reconstruct TCR sequence from germline segments
...
# asign mutated sequence
if (("TRA_full" %in% colnames(tcrTab)) & ("TRB_full" %in% colnames(tcrTab))){
  tcrTab$TCRa <- tcrTab$TRA_full 
  tcrTab$TCRb <- tcrTab$TRB_full 
}
